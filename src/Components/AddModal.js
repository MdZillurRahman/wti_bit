...
const submit = () => {
  ...
  return (
    <div className="uppercase">
      ...
      <div class="modal">
        <div class="modal-box ">
          <h3 class="text-lg font-bold my-4">Add Student</h3>
          ...
          <div >
            ...
            <div className="my-6 flex justify-end">
                <label className="my-6 flex justify-end text-[#2CA4D8] border border-[#2CA4D8] px-6 py-2 rounded-xl mr-4" htmlFor="addModal">Cancel</label>
                <label className="my-6 flex justify-end text-white border bg-[#2CA4D8] px-6 py-2 rounded-xl" onClick={submit}>Submit</label>
            </div>
          </div>
        </div>
      </div>
